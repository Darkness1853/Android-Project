...
***Задание по калькулятору***
Разработать простую версию калькулятора, используя TextView, Button и обработчик нажатия (onClickListener).

- Должен состоять из кнопок (от 0 до 9)
- Должен включать в состав Layout кнопки “действий” ( + , -, *, /, =)
- Должен включать в состав TextView для отображения результата нажатия на кнопку Button из пунктов 1 и 2.
- При нажатии на = обработать строку из TextView вручную и выполнить записанные в строку операции
