...
Мой [submodule](https://github.com/Darkness1853/Android-Backend-Server) 
...
7. [Клиент-серверное приложение](#7-клиент-серверное-приложение)
8. [Сокеты](#8-сокеты)
9. [Backend-сервер на C++](#9-backend-сервер-на-c)
...
[Перейти в Клиент](https://github.com/Darkness1853/Android-Project/tree/client_C%2B%2B)

[Перейти в Сервер](https://github.com/Darkness1853/Android-Backend-Server) (submodule)
